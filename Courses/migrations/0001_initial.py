    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.CharField(choices=[('AC', 'active'), ('IA', 'inactive'), ('MO', 'modifying')], default='IA', max_length=2, verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Action', models.BooleanField(verbose_name='Created')),
